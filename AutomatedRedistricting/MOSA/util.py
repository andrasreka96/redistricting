...
import AutomatedRedistricting.layer_manipulation
...
class Util:
    ...
    def __init__(self,features=None,layer=None,layer2=None):
        ...
        self.feature_dict_poligon = {f[self.attributes['attribute_id']]: f for f in layer.getFeatures()}
        self.layer_poliline=layer2
        self.feature_dict_poliline = {f[self.attributes['attribute_id_poliline']]: f for f in layer2.getFeatures()}
